...
abstract class BaseModel
{
    ...
    private function prepareDataInsert(array $data)
    {
        ...
        $strKeys = substr($strKeys, 1); //pulando a primera virgura
        $strBinds = substr($strBinds, 1); //pulando a primera virgura
    ...
    private function prepareDataUpdate(array $data)
    {
        ...
        $strKeysBinds = substr($strKeysBinds, 1); //pulando a primera virgura
